...
function ModalNewGame({ open, handleClose }: IProps) {
  ...
  useEffect(() => {
    ...
    const filteredParticipants = localParticipants.filter((participants) => !participants.eliminated)
        ...
        <div className={styles.backdrop}>
          <div className={styles.modal}>
            ...
            <div className={styles["modal--buttons"]}>
              <button className="btn-outline--gray" onClick={handleClose}>Cancelar</button>
              <button className="btn-rounded--pink" onClick={handleCreateNewGame}>Confirmar</button>
            </div>
          </div>
        </div>
      )}
